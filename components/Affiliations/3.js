...
export default function Hero() {
  return (
    <section className="hero-section position-relative overflow-hidden">
      ...
      <div className="container position-relative" style={{ zIndex: 3 }}>
        <div className="row align-items-center g-5 g-lg-4">
          ...
          <div className="col-lg-7">
            ...
            {/* trust strip */}
            <div className="trust-strip d-flex flex-wrap align-items-center gap-4 mt-5 pt-4">
              <div className="trust-item">
                <div className="trust-num">100%</div>
                <div className="trust-lbl">Credentialed</div>
              </div>
              <span className="trust-sep d-none d-sm-inline-block" />
              <div className="trust-item">
                <div className="trust-num">DO</div>
                <div className="trust-lbl">Track Approved</div>
              </div>
              <span className="trust-sep d-none d-sm-inline-block" />
              <div className="trust-item">
                <div className="trust-num">TX</div>
                <div className="trust-lbl">Richardson Site</div>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-5">
            <div className="visual-stack position-relative">
              ...
              {/* floating logo card */}
              <div className="logo-card d-none d-md-flex">
                <div className="logo-mark">SH</div>
                <div>
                  <div className="logo-name">Sam Houston</div>
                  <div className="logo-sub">State University</div>
                </div>
              </div>
      ...
      {/* bottom marquee */}
      <div className="marquee-strip d-flex align-items-center">
        <div className="marquee-track">
          {Array.from({ length: 2 }).map((_, k) => (
            <div key={k} className="marquee-group d-flex align-items-center">
              <span>★ US SHAPE</span>
              <span className="dot">•</span>
              <span>SAM HOUSTON STATE UNIVERSITY</span>
              <span className="dot">•</span>
              <span>★ PREMIER PAIN CENTERS</span>
              <span className="dot">•</span>
              <span>CLINICAL ROTATION SITE</span>
              <span className="dot">•</span>
