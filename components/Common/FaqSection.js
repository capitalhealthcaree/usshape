...
const FaqSection = () => {
  ...
  return (
    <div className="faq-area-two py-4">
          ...
          <div className="col-lg-6">
            <Accordion allowZeroExpanded preExpanded={["a"]}>
              <AccordionItem uuid="a">
                ...
                <AccordionItemPanel>
                  <p>
                    ...
                    best to help the poor. therefore good volunteering can make
                    a campain a success.
                  </p>
                </AccordionItemPanel>
              </AccordionItem>
              ...
              <AccordionItem uuid="b">
                ...
                <AccordionItemPanel>
                  <p>
                    Nonprofits organigation always based on charity. charity is
                    for helping people, a great team always do best.
                  </p>
                </AccordionItemPanel>
              </AccordionItem>
              ...
              <AccordionItem uuid="d">
                ...
                <AccordionItemPanel>
                  <p>
                    There are many children aid local/international organigation
                    out there. we also do charity there. so another volunteer
                    organization can volunteer to join us.
                  </p>
                </AccordionItemPanel>
              </AccordionItem>
