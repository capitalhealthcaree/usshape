      ...
      details: (
        <div>
          ...
          <p>
            ...
            more) but these externs stay on their feet in Operating Room with
            me, sometimes 9-10 hrs with heavy lead on and drove all the way from
            Richardson to Hillsboro; at all eight locations without a single
            complaint.
          </p>
          <p>
            They learnt all aspects of interventional pain management within
            scope of externship. What are ACGME core competencies. We support
            their residency candidacy by all means including but not limited to
            writing excellent LORs highlighting ACGME core competencies!
          </p>
        </div>
      ),
      ...
      details: (
        <div>
          <p>
            ...
            Fort Worth completed yesterday! This is 6th batch of current year.
          </p>
          <p>
            Dr Maha Awaiz and Dr Zobia; both DOW grads did an amazing job and
            worked more like “residents”. One month rotation at all locations
            and learnt all aspects of interventional pain management within
            scope of externship.
          </p>
        </div>
      ),
      ...
      details: (
        <div>
          ...
          <p>
            ...
            contributions. it’s great to know that physicians rotating with us
            at Premier Pain Centers matched in their desired programs.
          </p>
          <p>
      ...
      details: (
        <div>
          <p>
            ...
            Aijaz, Maha Awaiz Hassan, and all others who successfully matched
            this year.
          </p>
        </div>
      ),
      ...
      <div className="blog-area pt-5 pb-5">
        <div className="container">
          ...
          <div className="row justify-content-center">
            {alumniSuccessStoriesData.map((item, i) => {
              return (
