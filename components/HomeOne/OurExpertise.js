                ...
                <div className="row">
                  <div className="col-sm-6 col-lg-6">
                    <div className="expertise-inner">
                      ...
                      <h3>
                        <Link href="/doctor-details">Poverty Alleviation</Link>
                      </h3>
                      <p>
                  ...
                  <div className="col-sm-6 col-lg-6">
                    <div className="expertise-inner">
                      ...
                      <h3>
                        <Link href="/doctor-details">Charity For Live</Link>
                      </h3>
                      <p>
                  ...
                  <div className="col-sm-6 col-lg-6">
                    <div className="expertise-inner">
                      ...
                      <h3>
                        <Link href="/doctor-details">Health & Medicine</Link>
                      </h3>
                      <p>
                  ...
                  <div className="col-sm-6 col-lg-6">
                    <div className="expertise-inner">
                      ...
                      <h3>
                        <Link href="/doctor-details">Child Education</Link>
                      </h3>
                      <p>
